...
public class Users {
	...
	@NotNull
	private double finalRewardPoints;
	...
	public Users(int id, String firstName, String lastName, int age, String gender, long contactNumber, String userId,
			...
			String answer2, String question3, String answer3, double finalRewardPoints) {
		super();
		this.id = id;
	...
	public double getfinalRewardPoints() {
		return finalRewardPoints;
	}



	public void setfinalRewardPoints(double finalRewardPoints) {
		this.finalRewardPoints = finalRewardPoints;
	}
